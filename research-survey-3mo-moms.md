...
**Format:** Written survey, ~15–20 minutes. Recommend Google Forms (free) or Typeform.

**Target sample:** 10 completed responses. Aim to recruit 20–25 to get 10 thoughtful ones.

---

## Survey intro (paste at top of form)
...
>
> Thank you. The honest, messy answers help me the most.
...
18. Which of these did you use for breastfeeding help? *(check all that apply)*
    ...
    - On-demand video help (Pacify or similar)
    - Your OB-GYN or pediatrician
    - WIC peer counselor
    - La Leche League
    - A postpartum doula
    - Reddit (r/breastfeeding, r/newparents, etc.)
    - Facebook breastfeeding groups
    - TikTok or Instagram creators *(if yes, which ones do you trust?)*
    - YouTube videos
    - A book — which one(s)?
    - Mom friends or family
...
Highest signal, lowest friction:
- **r/breastfeeding** (200k+ members) — read the rules first; many subreddits require mod approval for research posts
- **r/NewParents**, **r/beyondthebump**, **r/Mommit**
- Local "Mom" Facebook groups in your city — these often have stricter rules but better response rates
- Your own network: friends-of-friends with babies 2-5 months old
- Postpartum / pelvic floor PT clinics if you know any locally — ask if they'd share

## What to post

> **Looking for 10 moms with 2–5 month old babies — paid, 15 minutes**
>
> Hi all. I'm researching how moms actually experienced breastfeeding in the first few months — what worked, what didn't, what you wish had existed. I'm a mom myself and I'm trying to understand this honestly, not sell anything.
>
> If your baby is roughly 2–5 months old, I'd love your help with a 15-minute survey. I'm sending **a $20 Amazon gift card** to the first 10 people who complete it.
>
> Open to ALL experiences: exclusively breastfeeding, combo, formula, stopped early, never started. The moms who had a rough time are the ones I most want to hear from.
>
> Survey: [your link]
>
> Comment or DM with questions. Thank you.

## Notes on incentives

A $20 gift card per response (~$200 total) dramatically improves both response rate AND response quality vs. unpaid surveys. Unpaid responses skew toward people with strong opinions; paid responses get you the messy middle, which is who you actually need to understand. Consider it the cheapest market research you'll ever buy.

## Diversity to watch for

Try to get at least:
- 2 moms who stopped breastfeeding earlier than they wanted
- 2 moms who are combo feeding
- 2 first-time moms
- 1 mom who had a NICU stay or premature baby
- 1 mom of color (BIPOC breastfeeding rates are persistently lower in US data and the reasons are under-researched — your product can't work for them if your research doesn't include them)
- 1 mom who chose formula from the start (her perspective on *why* is valuable signal too)

If your first 10 responses are all white, college-educated, first-time moms who exclusively breastfed, your sample is broken and you need to recruit harder.

---

# How to analyze the responses

After all 10 come in, do this in one sitting (~2 hours):

## Step 1 — Read all 10 cold

Read every response start-to-finish without taking notes. Get a feel for the range. Resist the urge to start coding immediately.

## Step 2 — Tag by theme

Open a spreadsheet with the open-ended questions as rows and mom IDs as columns. For each open answer, write a 1-line summary. Then look for repeated themes — phrases or pain points that show up in 3+ responses. Those are signal. Things only one mom said are interesting but not yet signal.
...
After tagging, write a 1-page synthesis with these sections:
- 3 patterns I expected and saw confirmed
- 3 patterns I expected and did NOT see
- 3 things that surprised me
- The single most-quoted phrase or pain point across responses
- My updated POV on the wedge

Ping me with the synthesis when it's done and I'll help you turn it into Experiment 3 (the Figma stepper prototype) targeting the specific gaps the data revealed.
